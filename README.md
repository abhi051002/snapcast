...
First of all I want to thank you  <a href="https://www.youtube.com/@javascriptmastery/videos" target="_blank"><b>JavaScript Mastery</b></a> for creating such valueable videos.
...
```bash
git clone https://github.com/abhi051002/snapcast.git
cd screencast
```
